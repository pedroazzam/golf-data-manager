...
CREATE TABLE pessoal (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, nome VARCHAR(50) UNIQUE, email VARCHAR(100) UNIQUE, cpf VARCHAR(15) UNIQUE, codigo_assessor VARCHAR(10) UNIQUE, repasse_assessor NUMBER, codigo_banco INTEGER, agencia VARCHAR(50), conta VARCHAR(50), dv VARCHAR(3));
